...
- **Overall Progress**: 33/41 Tasks (Completed details in [BACKLOG_HISTORY.md](BACKLOG_HISTORY.md))
...
graph TD
    ...
    TASK_041["TASK_041:<br>Emit canonical `cc_test` rules for self-contained test binaries"]:::pending
