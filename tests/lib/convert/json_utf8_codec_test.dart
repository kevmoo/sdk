...
class _ReentrantCustomObject {
  ...
  Map<String, dynamic> toJson() {
    ...
    b.add(jsonUtf8Encode(value));
    b.add(jsonUtf8Encode(text));
    if (child != null) {
...
void testCanonicalLargeIntegers() {
  ...
  // JsonTokenReader.readInt throws FormatException on overflow
  Expect.throwsFormatException(
    () => JsonTokenReader.fromBytes(posBytes).readInt(),
  );
  ...
  Expect.throwsFormatException(
    () => JsonTokenReader.fromBytes(negBytes).readInt(),
  );
