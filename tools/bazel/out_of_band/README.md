...
- **Nested-subrepo DEPS pins** — checked out to the revision current SDK source
  compiles against:
  - `third_party/pkg/native` → `b814f5393753e0cd752ce3ad733f5e66dd5949ce`
    (record_use API; rebuilds `kernel_service.dill`).
  - `third_party/pkg/tools` → `6a7dd15748e63db7d41cfee8294c54636b668f41`
    (`package:unified_analytics` API: `DashEnvVar` / `ideName` /
